...
unsigned int BottomUpRecursiveOpenMpAlgorithm::updateValue(const FlowDirectionMatrix& reversalDirectionMatrix, int row, int col, FlowAccumulationMatrix& accumulationMatrix)
{
...
FlowAccumulationMatrix BottomUpRecursiveOpenMpAlgorithm::execute(const FlowDirectionMatrix& directionMatrix)
{
